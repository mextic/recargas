    ...
    async insertBatchRechargesWithAnalytics(recharges, analyticsData) {
        ...
        try {
            ...
            for (let i = 0; i < recharges.length; i++) {
                ...
                let detalleText = `${detailNote} | [ Saldo Final: ${saldoFinal} ] Empresa: ${recharge.record.empresa} > Folio: ${folio}, Cantidad: $${recharge.importe}, Teléfono: ${telefono}, Carrier: ${carrier}, Fecha: ${fechaRecarga}, TransID: ${transID}, Timeout: ${timeout}, IP: ${ip}`;
