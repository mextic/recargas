...
class BaseRechargeProcessor {
    ...
    // ===== MÉTODOS WEBSERVICE - SE IMPLEMENTARÁN EN WEBSERVICECLIENT =====
    
    /**
     * Obtiene balance de TAECEL (será movido a WebserviceClient)
     */
    async getTaecelBalance() {
        throw new Error('getTaecelBalance() será implementado en WebserviceClient');
    }

    /**
     * Obtiene balance de MST (será movido a WebserviceClient)
     */
    async getMstBalance() {
        throw new Error('getMstBalance() será implementado en WebserviceClient');
    }
}
