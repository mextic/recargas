...
class GPSRechargeProcessor extends BaseRechargeProcessor {
    ...
    async processRecords(records, stats) {
        ...
        progressBar.complete(`✅ Completado: ${stats.successful} exitosos, ${stats.failed} errores en ${elapsedTime > 60 ? Math.floor(elapsedTime/60) + 'm ' + (elapsedTime%60) + 's' : elapsedTime + 's'}`);
