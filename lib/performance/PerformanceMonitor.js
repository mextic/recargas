...
class PerformanceMonitor {
    ...
    getStats() {
        ...
        // Calcular hit ratio basado en operaciones exitosas
        const sessionDuration = Date.now() - this.currentSession.startTime;
        const totalOps = this.currentSession.operations;
        const errors = this.currentSession.errors;
        const successes = totalOps - errors;
        const hitRatio = totalOps > 0 ? Math.round((successes / totalOps) * 100) : 100;
        ...
        return {
            ...
            operationsPerHour: report.session.operationsPerHour,
